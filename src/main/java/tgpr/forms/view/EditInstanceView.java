...
public class EditInstanceView extends DialogWindow {
    ...
    private void ViewSubmission() {
        ...
        Label submitterLabel = new Label("Submitted by: " +  (latestInstanceByForm.getCompleted() != null ? latestInstanceByForm.getCompleted() : "null"));
    ...
    private void createOrUpdateButtonsViewSubmission(List<Question> questions) {
        ...
        Button cancelButton = new Button("Cancel", this::close) ;
            ...
            // Fermez ou retournez à l'écran précédent ici// par exemple : setComponent(previousScree);
